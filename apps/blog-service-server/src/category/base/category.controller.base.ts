...
import { PostCategoryFindManyArgs } from "../../postCategory/base/PostCategoryFindManyArgs";
import { PostCategory } from "../../postCategory/base/PostCategory";
...
export class CategoryControllerBase {
  ...
  @common.Get("/:id/postCategories")
  @ApiNestedQuery(PostCategoryFindManyArgs)
  async findPostCategories(
    @common.Req() request: Request,
    @common.Param() params: CategoryWhereUniqueInput
  ): Promise<PostCategory[]> {
    const query = plainToClass(PostCategoryFindManyArgs, request.query);
    const results = await this.service.findPostCategories(params.id, {
      ...query,
      select: {
        category: {
          select: {
  ...
  @common.Post("/:id/postCategories")
  async connectPostCategories(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: PostCategoryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      postCategories: {
        connect: body,
  ...
  @common.Patch("/:id/postCategories")
  ...
  @common.Delete("/:id/postCategories")
  async disconnectPostCategories(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: PostCategoryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
