...
import { PostCategoryListRelationFilter } from "../../postCategory/base/PostCategoryListRelationFilter";
...
class PostWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PostCategoryListRelationFilter,
  })
  @ValidateNested()
  @Type(() => PostCategoryListRelationFilter)
  @IsOptional()
  @Field(() => PostCategoryListRelationFilter, {
    nullable: true,
  })
